...
CREATE TABLE orderitem (
  ...
  FOREIGN KEY (orderid) REFERENCES aula2409.order (id)
  );
...
INSERT INTO aula2409.order (Id,orderDate,customerId,TotalAmount,orderNumber)VALUES(1,'2012-01-01',78,1863.40,'542379');
INSERT INTO aula2409.order (Id,orderDate,customerId,TotalAmount,orderNumber)VALUES(2,'2012-01-01',78,1863.40,'542379');
INSERT into aula2409.order (Id,orderDate,customerId,TotalAmount,orderNumber)VALUES(3,'2012-01-01',34,1813.00,'542380');
INSERT into aula2409.order (Id,orderDate,customerId,TotalAmount,orderNumber)VALUES(4,'2012-01-01',84,670.80,'542381');
INSERT into aula2409.order (Id,orderDate,customerId,TotalAmount,orderNumber)VALUES(5,'2012-01-02',76,3730.00,'542382');
INSERT into aula2409.order (Id,orderDate,customerId,TotalAmount,orderNumber)VALUES(6,'2012-01-03',34,1444.80,'542383');
INSERT into aula2409.order (Id,orderDate,customerId,TotalAmount,orderNumber)VALUES(7,'2012-01-04',14,625.20,'542384');
INSERT into aula2409.order (Id,orderDate,customerId,TotalAmount,orderNumber)VALUES(8,'2012-01-01',68,2490.50,'542385');
INSERT into aula2409.order (Id,orderDate,customerId,TotalAmount,orderNumber)VALUES(9,'2012-01-01',88,517.80,'542386');
INSERT into aula2409.order (Id,orderDate,customerId,TotalAmount,orderNumber)VALUES(10,'2012-01-03',35,1119.90,'542387');
INSERT into aula2409.order (Id,orderDate,customerId,TotalAmount,orderNumber)VALUES(11,'2012-01-04',20,2018.60,'542388');
INSERT into aula2409.order (Id,orderDate,customerId,TotalAmount,orderNumber)VALUES(12,'2012-01-04',13,100.80,'542389');
INSERT into aula2409.order (Id,orderDate,customerId,TotalAmount,orderNumber)VALUES(13,'2012-01-02',56,1746.20,'542390');
INSERT into aula2409.order (Id,orderDate,customerId,TotalAmount,orderNumber)VALUES(14,'2012-01-01',61,448.00,'542391');
INSERT into aula2409.order (Id,orderDate,customerId,TotalAmount,orderNumber)VALUES(15,'2012-01-01',65,624.80,'542392');
INSERT into aula2409.order (Id,orderDate,customerId,TotalAmount,orderNumber)VALUES(16,'2012-01-01',20,2464.80,'542393');
INSERT into aula2409.order (Id,orderDate,customerId,TotalAmount,orderNumber)VALUES(17,'2012-01-03',24,724.50,'542394');
INSERT into aula2409.order (Id,orderDate,customerId,TotalAmount,orderNumber)VALUES(18,'2012-01-07',7,1176.00,'542395');
INSERT into aula2409.order (Id,orderDate,customerId,TotalAmount,orderNumber)VALUES(19,'2021-01-01',87,364.80,'542396');
INSERT into aula2409.order (Id,orderDate,customerId,TotalAmount,orderNumber)VALUES(20,'2021-01-01',25,4031.00,'542397');
INSERT into aula2409.order (Id,orderDate,customerId,TotalAmount,orderNumber)VALUES(21,'2012-01-04',33,1101.20,'542398');
INSERT into aula2409.order (Id,orderDate,customerId,TotalAmount,orderNumber)VALUES(22,'2020-01-01',89,676.00,'542399');
INSERT into aula2409.order (Id,orderDate,customerId,TotalAmount,orderNumber)VALUES(23,'2012-01-02',87,1376.00,'542400');
INSERT into aula2409.order (Id,orderDate,customerId,TotalAmount,orderNumber)VALUES(24,'2012-01-02',75,48.00,'542401');
INSERT into aula2409.order (Id,orderDate,customerId,TotalAmount,orderNumber)VALUES(25,'2019-01-01',65,1456.00,'542402');
INSERT into aula2409.order (Id,orderDate,customerId,TotalAmount,orderNumber)VALUES(26,'2012-01-02',63,2142.40,'542403');
INSERT into aula2409.order (Id,orderDate,customerId,TotalAmount,orderNumber)VALUES(27,'2012-01-02',85,538.60,'542404');

select * from aula2409.order;

INSERT orderitem (Id,orderId,productId,UnitPrice,Quantity)VALUES(1,1,11,14.00,12);
INSERT orderitem (Id,orderId,productId,UnitPrice,Quantity)VALUES(2,1,42,9.80,10);
INSERT orderitem (Id,orderId,productId,UnitPrice,Quantity)VALUES(3,1,72,34.80,5);
INSERT orderitem (Id,orderId,productId,UnitPrice,Quantity)VALUES(4,2,14,18.60,9);
INSERT orderitem (Id,orderId,productId,UnitPrice,Quantity)VALUES(5,2,51,42.40,40);
INSERT orderitem (Id,orderId,productId,UnitPrice,Quantity)VALUES(6,3,41,7.70,10);
INSERT orderitem (Id,orderId,productId,UnitPrice,Quantity)VALUES(7,3,51,42.40,35);
INSERT orderitem (Id,orderId,productId,UnitPrice,Quantity)VALUES(8,3,65,16.80,15);
INSERT orderitem (Id,orderId,productId,UnitPrice,Quantity)VALUES(9,4,22,16.80,6);
INSERT orderitem (Id,orderId,productId,UnitPrice,Quantity)VALUES(10,4,57,15.60,15);
INSERT orderitem (Id,orderId,productId,UnitPrice,Quantity)VALUES(11,4,65,16.80,20);
INSERT orderitem (Id,orderId,productId,UnitPrice,Quantity)VALUES(12,5,20,64.80,40);
INSERT orderitem (Id,orderId,productId,UnitPrice,Quantity)VALUES(13,5,33,2.00,25);
INSERT orderitem (Id,orderId,productId,UnitPrice,Quantity)VALUES(14,5,60,27.20,40);
INSERT orderitem (Id,orderId,productId,UnitPrice,Quantity)VALUES(15,6,31,10.00,20);
INSERT orderitem (Id,orderId,productId,UnitPrice,Quantity)VALUES(16,6,39,14.40,42);
INSERT orderitem (Id,orderId,productId,UnitPrice,Quantity)VALUES(17,6,49,16.00,40);
INSERT orderitem (Id,orderId,productId,UnitPrice,Quantity)VALUES(18,7,24,3.60,15);
INSERT orderitem (Id,orderId,productId,UnitPrice,Quantity)VALUES(19,7,55,19.20,21);
INSERT orderitem (Id,orderId,productId,UnitPrice,Quantity)VALUES(20,7,74,8.00,21);
INSERT orderitem (Id,orderId,productId,UnitPrice,Quantity)VALUES(21,8,2,15.20,20);
INSERT orderitem (Id,orderId,productId,UnitPrice,Quantity)VALUES(22,8,16,13.90,35);
INSERT orderitem (Id,orderId,productId,UnitPrice,Quantity)VALUES(23,8,36,15.20,25);
INSERT orderitem (Id,orderId,productId,UnitPrice,Quantity)VALUES(24,8,59,44.00,30);
INSERT orderitem (Id,orderId,productId,UnitPrice,Quantity)VALUES(25,9,53,26.20,15);
INSERT orderitem (Id,orderId,productId,UnitPrice,Quantity)VALUES(26,9,77,10.40,12);
INSERT orderitem (Id,orderId,productId,UnitPrice,Quantity)VALUES(27,10,27,35.10,25);
INSERT orderitem (Id,orderId,productId,UnitPrice,Quantity)VALUES(28,10,39,14.40,6);
INSERT orderitem (Id,orderId,productId,UnitPrice,Quantity)VALUES(29,10,77,10.40,15);
INSERT orderitem (Id,orderId,productId,UnitPrice,Quantity)VALUES(30,11,2,15.20,50);
INSERT orderitem (Id,orderId,productId,UnitPrice,Quantity)VALUES(31,11,5,17.00,65);
INSERT orderitem (Id,orderId,productId,UnitPrice,Quantity)VALUES(32,11,32,25.60,6);
INSERT orderitem (Id,orderId,productId,UnitPrice,Quantity)VALUES(33,12,21,8.00,10);
INSERT orderitem (Id,orderId,productId,UnitPrice,Quantity)VALUES(34,12,37,20.80,1);
INSERT orderitem (Id,orderId,productId,UnitPrice,Quantity)VALUES(35,13,41,7.70,16);
INSERT orderitem (Id,orderId,productId,UnitPrice,Quantity)VALUES(36,13,57,15.60,50);
INSERT orderitem (Id,orderId,productId,UnitPrice,Quantity)VALUES(37,13,62,39.40,15);
INSERT orderitem (Id,orderId,productId,UnitPrice,Quantity)VALUES(38,13,70,12.00,21);
INSERT orderitem (Id,orderId,productId,UnitPrice,Quantity)VALUES(39,14,21,8.00,20);
INSERT orderitem (Id,orderId,productId,UnitPrice,Quantity)VALUES(40,14,35,14.40,20);
INSERT orderitem (Id,orderId,productId,UnitPrice,Quantity)VALUES(41,15,5,17.00,12);
INSERT orderitem (Id,orderId,productId,UnitPrice,Quantity)VALUES(42,15,7,24.00,15);
INSERT orderitem (Id,orderId,productId,UnitPrice,Quantity)VALUES(43,15,56,30.40,2);
INSERT orderitem (Id,orderId,productId,UnitPrice,Quantity)VALUES(44,16,16,13.90,60);
INSERT orderitem (Id,orderId,productId,UnitPrice,Quantity)VALUES(45,16,24,3.60,28);
INSERT orderitem (Id,orderId,productId,UnitPrice,Quantity)VALUES(46,16,30,20.70,60);
INSERT orderitem (Id,orderId,productId,UnitPrice,Quantity)VALUES(47,16,74,8.00,36);
INSERT orderitem (Id,orderId,productId,UnitPrice,Quantity)VALUES(48,17,2,15.20,35);
INSERT orderitem (Id,orderId,productId,UnitPrice,Quantity)VALUES(49,17,41,7.70,25);
INSERT orderitem (Id,orderId,productId,UnitPrice,Quantity)VALUES(50,18,17,31.20,30);
INSERT orderitem (Id,orderId,productId,UnitPrice,Quantity)VALUES(51,18,70,12.00,20);
INSERT orderitem (Id,orderId,productId,UnitPrice,Quantity)VALUES(52,19,12,30.40,12);
INSERT orderitem (Id,orderId,productId,UnitPrice,Quantity)VALUES(53,20,40,14.70,50);
INSERT orderitem (Id,orderId,productId,UnitPrice,Quantity)VALUES(54,20,59,44.00,70);
INSERT orderitem (Id,orderId,productId,UnitPrice,Quantity)VALUES(55,20,76,14.40,15);
INSERT orderitem (Id,orderId,productId,UnitPrice,Quantity)VALUES(56,21,29,99.00,10);
INSERT orderitem (Id,orderId,productId,UnitPrice,Quantity)VALUES(57,21,72,27.80,4);
INSERT orderitem (Id,orderId,productId,UnitPrice,Quantity)VALUES(58,22,33,2.00,60);
INSERT orderitem (Id,orderId,productId,UnitPrice,Quantity)VALUES(59,22,72,27.80,20);
INSERT orderitem (Id,orderId,productId,UnitPrice,Quantity)VALUES(60,23,36,15.20,30);
INSERT orderitem (Id,orderId,productId,UnitPrice,Quantity)VALUES(61,23,43,36.80,25);
INSERT orderitem (Id,orderId,productId,UnitPrice,Quantity)VALUES(62,24,33,2.00,24);
INSERT orderitem (Id,orderId,productId,UnitPrice,Quantity)VALUES(63,25,20,64.80,6);
INSERT orderitem (Id,orderId,productId,UnitPrice,Quantity)VALUES(64,25,31,10.00,40);
INSERT orderitem (Id,orderId,productId,UnitPrice,Quantity)VALUES(65,25,72,27.80,24);
INSERT orderitem (Id,orderId,productId,UnitPrice,Quantity)VALUES(66,26,10,24.80,24);
INSERT orderitem (Id,orderId,productId,UnitPrice,Quantity)VALUES(67,26,31,10.00,15);
INSERT orderitem (Id,orderId,productId,UnitPrice,Quantity)VALUES(68,26,33,2.00,20);
INSERT orderitem (Id,orderId,productId,UnitPrice,Quantity)VALUES(69,26,40,14.70,60);
...
insert into vw_customermadrid (id, firstname, lastname, city, country, phone)
values (9999,'sandro', 'servino de madrid', 'Madrid', 'espanha', '9999999');

insert into vw_customerMadrid (firstname, lastname, city, country, phone)
values ('sandro', 'servino de porto', 'Madrid', 'espanha', '9999999');

select * from vw_customerMadrid;

select * from customer where lastname = 'servino do porto';

CREATE VIEW vw_customerMadrid AS
SELECT id, firstname, lastname, city, country, phone
FROM customer
WHERE city = 'Madrid';

create view dailysales as select year(orderdate) as y, month(orderdate) as n, day(orderdate) as d, p.id,productname,quantity * i.unitprice as sales
from CLIENTE2.Order as o inner join orderiten as i on o.id = i.orderid inner join product as p on p.id= i.productid;
...
create view vw_fornecedores_contato as select companyname, contactname,
phone from supplier;

create view vw_produtos_ativos as select * from product 
where isdiscontinued = 0;

create view vw_clientes_resumo as select firstname as nome, lastname as Sobrenome,
country as Pais_Origem from customer;

create view vw_detalhes_produto_fornecedor as 
select p.productname, s.companyname from product p inner join
supplier s on s.id = p.supplierid;

create view vw_quantidade_itens_pedido as select o.orderid, count(*) 
from orderitem o group by o.orderid;
